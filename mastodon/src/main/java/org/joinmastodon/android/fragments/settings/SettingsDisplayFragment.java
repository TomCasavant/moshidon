...
public class SettingsDisplayFragment extends BaseSettingsFragment<Void>{
	...
	// MOSHIDON
	private  CheckableListItem<Void> enableDoubleTapToSwipeItem, relocatePublishButtonItem, showPostDividersItem, enableDoubleTapToSearchItem, showMediaPreviewItem, hideTagSymbol;
	...
	public void onCreate(Bundle savedInstanceState){
		...
		onDataLoaded(List.of(
				...
				hideTagSymbolItem=new CheckableListItem<>(R.string.mo_hide_tag_symbol, 0, CheckableListItem.Style.SWITCH, GlobalUserPreferences.hideTagSymbol, R.drawable.ic_fluent_image_24_regular, i->toggleCheckableItem(hideTagSymbol)),
